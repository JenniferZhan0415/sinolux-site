    ...
    return (
        <div className={styles.collection5}>
            <div className={styles.collectionEntry}>
                4日21日“欲与囚”单元的几部影片分别带来对人性的不同解读，我们可以看到狭小车站吸烟室里逐渐揭露的底层众生相，也能通过吃猪肉这样一件日常的事情，产生人类主客体质问。通过镜头，我们看见了因为极端的爱与占有而绽放的欲望之花，看见了通过最彻底的释放而挣脱内心深处枷锁的萎靡青年。黑色幽默的基调中，展现了为了一己私利而促成的荒诞场面。若对欲望不理解，就永远不能从桎梏和恐惧中解脱；若摧毁了欲望，却也摧毁了生活；若扭曲压抑着欲望，同时也就摧毁了非凡之美。生命没有终极意义，我们需要在最沉痛的生命观里重新审视当下的欲望。
            </div>
            <div className={styles.collectionEntry}>
                <div>
