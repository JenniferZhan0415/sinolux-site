    ...
    return (
        <div className={styles.collection}>
            <div className={styles.collectionEntry}>
                万物皆有裂痕，那是光照进来的地方。4月20日“裂痕”单元带来的四部短片，讲述了四位女性的故事，她们中，有人是立志拯救同志群体的地球上最后一位百合，是奋力抓住一切希望却换来了谎言与欺骗的十七岁少女，是在同性恋儿子与宗教信仰中踌躇的母亲，是一对脆弱且在破碎边缘的亲密友人。她们都曾倔强且笃定，渴望抓住一个明晰的梦，却不得不在割裂和冲突中醒来。
            </div>
            <div className={styles.collectionEntry}>
                <div>
