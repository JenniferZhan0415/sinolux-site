...
const about = {
    ...
    zh: (<p>
        我们是第一个与多伦多国际电影节（<a href="https://tiff.net/">TIFF</a>）成为伙伴关系的
        华语影展，也是第一个近年连续在 <a href="https://www.tiff.net/visit">TIFF BELL LIGHTBOX</a> 举办的华语影展。华光电影是加拿大联邦注册的非盈利组织，专注于
